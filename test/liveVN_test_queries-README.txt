Following are descriptions of the four test query CSV files (liveVN_test_queries*.csv).
...
liveVN_test_queries-big_resultsets.csv:  This is a set of test queries that all produce result sets in excess of 10,000 records but less than 300,000 records.
